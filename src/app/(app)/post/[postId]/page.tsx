...
import { canCommentInChannel, channelHref } from "@/lib/community/structure";

type Params = Promise<{ postId: string }>;

// Fase 6.6 — rota CANÔNICA do detalhe de post. A antiga /community/[postId] redireciona.
export default async function PostDetailPage({ params }: { params: Params }) {
  ...
  const backHref = channelHref(post.category) ?? "/community";
